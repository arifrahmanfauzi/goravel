	...
	config.Add("database", map[string]any{
		...
		"connections": map[string]any{
			...
			"mongodb": map[string]any{
				"driver":   "mongodb",
				"dsn":      config.Env("DB_STRING", ""),
				"host":     config.Env("DB_HOST_MONGO", ""),
				"port":     config.Env("DB_PORT_MONGO", ""),
				"database": config.Env("DB_DATABASE_MONGO", ""),
				"username": config.Env("DB_USERNAME_MONGO", ""),
				"password": config.Env("DB_PASSWORD_MONGO", ""),
				"options": map[string]any{
					"database": config.Env("DB_AUTHENTICATION_DATABASE", ""),
				},
			},
